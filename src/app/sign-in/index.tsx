...
export const metadata: Metadata = {
  title: 'Вход в личный кабинет - Ваш магазин',
  description: 'Войдите в личный кабинет, используя ваш электронный адрес и пароль. Если вы забыли пароль, воспользуйтесь функцией восстановления.',
  keywords: 'вход в личный кабинет, авторизация, вход, восстановление пароля, регистрация',
  icons: '/favicon.ico',
};
