...
export const metadata: Metadata = {
  title: 'Профиль пользователя - Ваш магазин',
  description: 'Просмотрите и обновите свои личные данные, просмотрите историю заказов и выполните выход из аккаунта. Здесь вы можете управлять своими данными и отслеживать статус своих заказов.',
  keywords: 'профиль пользователя, личные данные, история заказов, выход из аккаунта',
  icons: '/favicon.ico',
};
