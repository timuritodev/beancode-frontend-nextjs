...
export const metadata: Metadata = {
  title: 'Оплата прошла успешно - Подтверждение заказа',
  description: 'Ваш платеж был успешно обработан. Мы свяжемся с вами в ближайшее время для подтверждения деталей заказа. Спасибо за покупку!',
  keywords: 'успешная оплата, подтверждение заказа, платеж успешно завершен, информация о заказе',
  icons: '/favicon.ico',
};
