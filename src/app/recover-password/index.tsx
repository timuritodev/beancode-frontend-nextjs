...
export const metadata: Metadata = {
  title: 'Восстановление пароля - Ваш магазин',
  description: 'Введите свой электронный адрес для восстановления пароля. Если электронная почта указана правильно, вы получите инструкцию по восстановлению пароля.',
  keywords: 'восстановление пароля, забытый пароль, сброс пароля, электронная почта',
  icons: '/favicon.ico',
};
