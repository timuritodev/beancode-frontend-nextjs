...
export const metadata: Metadata = {
  title: 'Регистрация нового пользователя - Ваш магазин',
  description: 'Зарегистрируйтесь в нашем магазине, чтобы получить доступ к персонализированным услугам и предложениям. Введите свои данные, чтобы создать новый аккаунт.',
  keywords: 'регистрация, создать аккаунт, регистрация пользователя, новые пользователи, регистрация в магазине',
  icons: '/favicon.ico',
};
