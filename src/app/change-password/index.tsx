...
export const metadata: Metadata = {
  title: 'Смена пароля - Ваш аккаунт',
  description: 'Измените свой пароль на странице смены пароля. Для зарегистрированных пользователей с безопасными настройками и проверкой старого и нового пароля.',
  keywords: 'смена пароля, аккаунт, безопасность, изменение пароля, настройки',
  icons: '/favicon.ico',
};
