...
export const metadata: Metadata = {
  title: 'Каталог интернет-магазина кофе - Лучшие сорта для эспрессо',
  description: 'Откройте для себя наш ассортимент кофе для эспрессо: Бразилия, Америка, Африка, и наборы. Удобная сортировка по цене, кислотности и плотности.',
  keywords: 'каталог, кофе, интернет-магазин, эспрессо, Бразилия, Америка, Африка, наборы, сортировка',
  icons: '/favicon.ico',
};
