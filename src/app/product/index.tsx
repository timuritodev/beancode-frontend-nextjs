...
export const metadata: Metadata = {
  title: 'Страница продукта - Ваш магазин',
  description: 'Узнайте все подробности о нашем продукте, включая описание, цены и многое другое. Найдите похожие товары, которые вам могут понравиться.',
  keywords: 'страница продукта, подробности о продукте, покупка онлайн, слайдер продуктов',
  icons: '/favicon.ico',
};
